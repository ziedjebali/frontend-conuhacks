...
"function"==typeof e[n]&&(f[n]=e[n])}var l,h=Object.keys(f)
try{!function(r){Object.keys(r).forEach(function(e){var t=r[e]
...
throw Error(d)}i[c]=s,o=o||s!==u}return o?i:e}}function d(e,t){return function(){return t(e.apply(this,arguments))}}function f(t,e){var r=Object.keys(t)
return Object.getOwnPropertySymbols&&r.push.apply(r,Object.getOwnPropertySymbols(t)),e&&(r=r.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),r}function m(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return 0===t.length?function(e){return e}:1===t.length?t[0]:t.reduce(function(e,t){return function(){return e(t.apply(void 0,arguments))}})}function g(){for(var e=arguments.length,i=Array(e),t=0;t<e;t++)i[t]=arguments[t]
...
return function(o){for(var e=1;e<arguments.length;e++){var i=null!=arguments[e]?arguments[e]:{}
e%2?f(i,!0).forEach(function(e){var t,r,n
n=i[r=e],r in(t=o)?Object.defineProperty(t,r,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[r]=n}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(i)):f(i).forEach(function(e){Object.defineProperty(o,e,Object.getOwnPropertyDescriptor(i,e))})}return o}({},e,{dispatch:t=m.apply(void 0,n)(e.dispatch)})}}}function w(e){void 0===e&&(e={})
...
return!t&&"object"==typeof window&&window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__?window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__(r):m}var O=Object.freeze({__DO_NOT_USE__ActionTypes:y,applyMiddleware:g,bindActionCreators:function(e,t){if("function"==typeof e)return d(e,t)
...
"function"==typeof o&&(r[n]=d(o,t))}return r},combineReducers:v,compose:m,createStore:b})
var x=[r,n],E=(S.prototype.forEachPlugin=function(e,t){for(var r=0,n=this.plugins;r<n.length;r++){var o=n[r]
o[e]&&t(o[e])}},S.prototype.getModels=function(t){return Object.keys(t).map(function(e){return l(l({name:e},t[e]),{reducers:t[e].reducers||{}})})},S.prototype.addModel=function(t){this.forEachPlugin("onModel",function(e){return e(t)})},S.prototype.init=function(){var t=this
this.models=this.getModels(this.config.models)
for(var e=0,r=this.models;e<r.length;e++)this.addModel(r[e])
var n=function(e){var u=this,t=e.redux,r=e.models,n=t.combineReducers||v,o=t.createStore||b,i=void 0!==t.initialState?t.initialState:{}
...
var s=this.createRootReducer(t.rootReducers),d=g.apply(O,t.middlewares),f=w(t.devtoolOptions).apply(void 0,h(t.enhancers,[d]))
return this.store=o(s,i,f),this}.call(this,{redux:this.config.redux,models:this.models}),o=l(l({name:this.config.name},n.store),{model:function(e){t.addModel(e),n.mergeReducers(n.createModelReducer(e)),n.store.replaceReducer(n.createRootReducer(t.config.redux.rootReducers)),n.store.dispatch({type:"@@redux/REPLACE "})}})
return this.forEachPlugin("onStoreCreated",function(e){var t=e(o)
t&&Object.keys(t||{}).forEach(function(e){o[e]=t[e]})}),o},S)
function S(e){var t=this
this.plugins=[],this.config=e,this.pluginFactory=function(e){return{config:e,validate:a,create:function(e){e.onInit&&e.onInit.call(this)
var t={}
...
e[c]&&(t[c]=e[c].bind(this))}return t}}}(e)
for(var r=0,n=x.concat(this.config.plugins);r<n.length;r++){this.plugins.push(this.pluginFactory.create(n[r]))}this.forEachPlugin("middleware",function(e){t.config.redux.middlewares.push(e)})}function j(e){console.warn(e)}function R(e,t){return t?l(l({},t),e||{}):e||{}}function P(e){void 0===e&&(e={})
var t=e.name||""+I
I+=1
...
if(o.config){var i=R(t.models,o.config.models)
t.models=i,t.plugins=h(t.plugins,o.config.plugins||[]),o.config.redux&&(t.redux.initialState=R(t.redux.initialState,o.config.redux.initialState),t.redux.reducers=R(t.redux.reducers,o.config.redux.reducers),t.redux.rootReducers=R(t.redux.rootReducers,o.config.redux.reducers),t.redux.enhancers=h(t.redux.enhancers,o.config.redux.enhancers||[]),t.redux.middlewares=h(t.redux.middlewares,o.config.redux.middlewares||[]),t.redux.combineReducers=t.redux.combineReducers||o.config.redux.combineReducers,t.redux.createStore=t.redux.createStore||o.config.redux.createStore)}}return t}(l(l({},e),{name:t}))
return new E(r).init()}var I=0,_={init:P}
e.createModel=function(e){return e},e.default=_,e.dispatch=function(){j("global dispatch has been removed in @rematch/core 1.0.0-beta.3.\n\tSee https://github.com/rematch/rematch/blob/master/CHANGELOG.md#100-beta3---2018-06-23 for details.\n\tFor a quick fix, import and use store.dispatch.")},e.getState=function(){j("global getState has been removed in @rematch/core 1.0.0-beta.3.\n\tSee https://github.com/rematch/rematch/blob/master/CHANGELOG.md#100-beta3---2018-06-23 for details.\n\tFor a quick fix, import and use store.getState.")},e.init=P,Object.defineProperty(e,"__esModule",{value:!0})})
